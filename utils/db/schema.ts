...
export const conferenceUpdateSchema = conferenceSchema.partial().and(z.object({
  id: z.coerce.number(),
  }));
...
export const speakerCreateSchema = speakerSchema.omit({id: true, created_at: true, updated_at: true, photo_url: true});
...
export const sessionUpdateSchema = sessionSchema.partial().and(z.object({
  id: z.coerce.number(),
  }));
